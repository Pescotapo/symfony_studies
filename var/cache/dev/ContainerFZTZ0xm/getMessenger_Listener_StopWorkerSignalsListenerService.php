...
class getMessenger_Listener_StopWorkerSignalsListenerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['messenger.listener.stop_worker_signals_listener'] = new \Symfony\Component\Messenger\EventListener\StopWorkerOnSignalsListener(NULL, ($container->privates['monolog.logger'] ?? self::getMonolog_LoggerService($container)));
    }
}
