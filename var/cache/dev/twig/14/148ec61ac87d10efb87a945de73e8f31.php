            ...
            foreach ($context['_seq'] as $context["name"] => $context["client"]) {
                ...
                if ((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["client"], "traces", [], "any", false, false, false, 97)) == 0)) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["trace"]) {
                        ...
                        // line 130
                        echo "                                        ";
                        if ( !(null === twig_get_attribute($this->env, $this->source, $context["trace"], "curlCommand", [], "any", false, false, false, 130))) {
                            // line 131
                            echo "                                            <th>
                        ...
                        echo "                                    <tr>
                                        ...
                                        <td";
                        // line 146
                        if (twig_get_attribute($this->env, $this->source, $context["trace"], "curlCommand", [], "any", false, false, false, 146)) {
                            echo " colspan=\"2\"";
                        }
                        echo ">
                                            ";
...
{% endblock %}
", "@WebProfiler/Collector/http_client.html.twig", "/data/data/com.termux/files/home/symfony5_studies/aula1/vendor/symfony/web-profiler-bundle/Resources/views/Collector/http_client.html.twig");
    }
}
